...
router.post('/vendors', async (req, res) => {
    const { name, city, street, house, flat, postcode, inn, phone } = req.body;
    try {
        await db.none(`
            INSERT INTO vendors (name, city, street, house, flat, postcode, inn, phone)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
        `, [name, city, street, house, flat || null, postcode || null, inn, phone || null]);
...
router.put('/vendors/:id', async (req, res) => {
    ...
    try {
        await db.none(`
            UPDATE vendors 
            SET name = $1, city = $2, street = $3, house = $4, flat = $5, postcode = $6, inn = $7, phone = $8
            WHERE id = $9
        `, [name, city, street, house, flat || null, postcode || null, inn, phone || null, req.params.id]);
